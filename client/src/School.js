		...
		return (
			<div id="School">
				<div className="container">
					<button className="back" onClick={this.props.backToList}>
						{' '}
						Back to all schools
					</button>
					...
					<div className="school-info">
						...
						<div className="weather">
							<p>
								The current weather in {this.state.school.city} is: {this.state.weather}.
							</p>
							<button onClick={() => this.getWeather()}>Go!</button>
						</div>
					</div>
					<div className="map">
						<iframe title="School Location" src={this.state.school.map} />
					</div>
				</div>
				...
				<div className="container" id="reviewform">
					...
					<form>
						...
						<input
							...
							placeholder="The time of my life!"
							onChange={this.updateInput}
						/>
						<br />
						...
						<input name="end_date" type="date" value={this.state.end_date} onChange={this.updateInput} />
						<br />
						<label>Likes</label> <br />
						<input name="likes" type="text" value={this.state.likes} onChange={this.updateInput} />
						<br />
						<label>Dislikes</label> <br />
						<input name="dislikes" type="text" value={this.state.dislikes} onChange={this.updateInput} />
						<br />
						<label>Overall impression of the city</label> <br />
						<input
							name="city_impression"
							type="text"
							value={this.state.city_impression}
							onChange={this.updateInput}
						/>
						<br />
						...
						<input
							name="general_review"
							type="text"
							value={this.state.general_review}
							onChange={this.updateInput}
						/>
						<br />
						<input type="submit" value="Submit" onClick={(e) => this.addReview(e)} />
					</form>
				</div>
			</div>
		);
